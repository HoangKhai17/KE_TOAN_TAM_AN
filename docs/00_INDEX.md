...
| 23 | [023_ATTENDANCE_PHASE1_FIX_PLAN.md](./023_ATTENDANCE_PHASE1_FIX_PLAN.md) | Chấm công GĐ1 — 5 fix logic: admin nghỉ phép, đè điều chỉnh tay, nghỉ không lương ăn công, thu hồi đơn, payroll ghi đè | ✅ Đã code + kiểm thử 40 ca HTTP |
| 24 | [024_ATTENDANCE_PHASE2_PLAN.md](./024_ATTENDANCE_PHASE2_PLAN.md) | Chấm công GĐ2 — Nhóm A (đếm ngày công đúng T7, chặn đơn trùng) ✅; Nhóm B (nghỉ nửa ngày, leave_policies) + C (quỹ phép) chờ chốt | ✅ A+B+C xong — 93/93 test |
